...
| Icon families | `icm#`, `ics#`, `cicn`, `icns` | typed decoders and exporters | Fold small bitmap/icon decoders into rsrcd; keep `icns` container handling adapter-backed until bounded. `ICN#`, `SICN`, `icl4`, `icl8`, `icm4`, `icm8`, `ics4`, and `ics8` now live in StackImport core. |
