...
| Color tables and patterns | `ppat`, `ppt#`, `pltt` | typed decoders and exporters | Fold bounded parsers into rsrcd. `PAT `, `clut`, `CTBL`, `actb`, `cctb`, `dctb`, `fctb`, and `wctb` now live in StackImport core. |
