...
- Remaining work: resource-fork parser/decoder adapter boundaries, the remaining
  direct `phosg` SHA-256 helper in ROM analysis, and broader license/provenance
  audit.
